...
nbr_thread, BA_algorithm, ORB_version = range(11), 'MABA', 'ORB2'
noise_type, BA_type, noise_level, nbr_iter, smooth_threshold = 'Random Walk', 'complete', np.linspace(0, 0.15, 11), 25, 1.15
...
split_seq = [0, len(keyframes_MH04), len(keyframes[0])]
...
## Save results
path = '/home/pb/Documents/Thesis/Data/Sensitivity analysis/MABA/Scenario 6/{}/'.format(sequence)
